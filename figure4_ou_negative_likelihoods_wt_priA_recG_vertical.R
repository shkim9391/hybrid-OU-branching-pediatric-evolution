# ============================================================
# figure3_profile_likelihoods_wt_priA_recG_vertical.R
# ============================================================
...
ggsave("figure3_profile_likelihoods_wt_priA_recG_vertical.png",
...
print(aic_tbl)
write_csv(aic_tbl, "AIC_comparison_Fig3_R.csv")
message("\nSaved: figure3_profile_likelihoods_wt_priA_recG_vertical.png and AIC_comparison_Fig3_R.csv")

# ------------------------------
# (Optional) also save a horizontal 1×3 layout
# ------------------------------
fig_horizontal <- cowplot::plot_grid(p_wt, p_priA, p_recG, ncol = 3, rel_widths = c(1,1,1))
ggsave("figure3_profile_likelihoods_wt_priA_recG_horizontal.png",
